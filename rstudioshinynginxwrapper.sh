...
sudo wget https://raw.githubusercontent.com/Jtsmith275/RStudioNginxShinyTeam/master/default -O /etc/shiny-server/shiny-server.conf
...
sudo wget https://raw.githubusercontent.com/jtsmith275/RStudioNginxShinyTeam/master/shiny-server.conf -O /etc/nginx/sites-enabled/shiny-server.conf
