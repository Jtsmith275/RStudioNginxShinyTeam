...
sudo cp https://raw.githubusercontent.com/jtsmith275/RStudioNginxShinyTeam/master/default -O /etc/nginx/sites-enabled/default
...
sudo cp https://raw.githubusercontent.com/jtsmith275/RStudioNginxShinyTeam/master/shiny-server.conf -O /etc/nginx/sites-enabled/shiny-server.conf
